...
| @version  1.3.1
|+-----------------------------------------------------------------------------+
| @author   Michael A. I. Lee [ http://iskitz.com/ ]
|
| Created:  Tuesday,   November   4, 2003    [2003.11.04]
| Modified: Saturday,  November  17, 2012    [2012.11.17 - 04:27:40 PST]
|+-----------------------------------------------------------------------------+
|
...
|
|           Copyright (c) 2003-2012 Michael A. I. Lee, iSkitz.com
|
|+-----------------------------------------------------------------------------+
|
| ***** BEGIN LICENSE BLOCK *****
...
(function/*com.iskitz.ajile*/(VERSION, undefined)
{
   ...
   {
      var modules = !(isString (fullName) && pendingImports.has (fullName))
...
paths:for(var path in paths)
   ...
   function handleImported(shortName, fullName, module, owner)
   {
      ...
      (shortName != fullName)           &&
      importListeners.has (shortName)   && notifyImportListeners (shortName);
      importListeners.has (fullName)    && notifyImportListeners (fullName);
      return module;
   }
